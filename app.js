...
app.get('/', function (req, res) {
  res.send('Welcome to the Home page!  <br><hr> <br>' +
    'Sources for learning Server-side programming:<br>'+
    '<ul>'+
    '<li>'+
    '<a href="https://developer.mozilla.org/en-US/docs/Learn/Server-side">Developer.mozilla</a>'+
    '</li>'+
    '<li>'+
    '<a href="https://www.w3schools.com/nodejs/">W3schools.net</a>'+
    '</li>'+
    '<li>'+
    '<a href="https://youtu.be/pYOltVz7kL0">Node.js Youtube tutorial</a>'+
    '</li>'+
    '</ul>'+
    '<hr>'+
